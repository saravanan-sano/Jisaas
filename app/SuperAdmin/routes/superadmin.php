...
ApiRoute::group(['namespace' => 'App\SuperAdmin\Http\Controllers\Api\Admin', 'middleware' => ['api.permission.check', 'api.auth.check']], function () {
    ...
    ApiRoute::post('upi-qrcode', ['as' => 'api.extra.upi.subscription', 'uses' => 'UpiSubscriptionController@UpiSubscription']);
...
ApiRoute::group(['namespace' => 'App\SuperAdmin\Http\Controllers\Api', 'prefix' => 'superadmin', 'middleware' => ['api.superadmin.check']], function () {
    ...
    ApiRoute::group(['prefix' => 'payment-settings'], function () {
        ...
        ApiRoute::post('upi/update', ['as' => 'api.payment-settings.upi.update', 'uses' => 'PaymentSettingsController@updateUpi']);
        ApiRoute::get('upi', ['as' => 'api.payment-settings.upi.index', 'uses' => 'PaymentSettingsController@getUpi']);
    });
});
