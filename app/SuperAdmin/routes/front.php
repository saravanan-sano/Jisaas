...
Route::group(['namespace' => 'Front'], function () {
    ...
    Route::any('/save-upi-invoices', ['as' => 'webhook.save-upi-invoices', 'uses' => 'PaymentWebhookController@saveUpiInvoices']);
    ...
    Route::group(['middleware' => ['web']], function () {
        ...
        Route::get('/thanks', ['as' => 'front.registerthanks', 'uses' => 'HomeController@thanks']);
