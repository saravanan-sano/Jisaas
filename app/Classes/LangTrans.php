...
class LangTrans
{
    public static $mainTranslations = [
        ...
        'delivery_partner' => [
            'add' => 'Add New Delivery Partners',
            'edit' => 'Edit Delivery Partners',
            'created' => 'Delivery Partners Created Successfully',
            'updated' => 'Delivery Partners Updated Successfully',
            'deleted' => 'Delivery Partners Deleted Successfully',
            'delivery_partner_details' => 'Delivery Partners Details',
            'delete_message' => 'Are you sure you want to delete this Delivery Partners?',
            'import_delivery_partner' => 'Import Delivery Partners',
        ],
        'customer' => [
        ...
        'warehouse' => [
            ...
            'is_last_history' => 'Show Last History',
            'is_card_gateway' => 'Card Paymemt',
            'cardpayment_method' => 'Card Payment Method',
            'square_access_key' => 'Access Key',
        ],
        'front_website' => [
            'home' => 'Home',
            'features' => 'Features',
        ...
        'product' => [
            ...
            'is_wholesale_only' => 'Only for Wholsale Customers',
        ],
        'stock' => [
        ...
        'setup_company' => [
            ...
            'setup_complete_message' => 'Awesome, your account has been set up. Please enter your company information to continue.',
        ]
    ];
