...
class ApiBaseController extends ApiController
{
    ...
    public function getIdArrayFromHash($values): array
    {
        $convertedArray = [];
    ...
    public function getHashArrayFromId($values): array
    {
        $convertedArray = [];
    ...
    public function errorMessageResponse($message): JsonResponse
    {
