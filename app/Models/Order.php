...
class Order extends BaseModel
{
    ...
    protected $default = ['xid','delivery_to','place_of_supply','reverse_charge','gr_rr_no','transport','vechile_no','station','buyer_order_no'];
    ...
    {
        return $this->belongsTo(StaffMember::class, 'user_id', 'id')->withoutGlobalScope('stype');
    }
    ...
    public function orderPayments1()
    {
        return $this->hasMany(OrderPayment::class, 'order_id', 'id');
    }
