...
class Customer extends BaseModel implements AuthenticatableContract, JWTSubject
{
    ...
    protected $default = ["xid", "name", "phone", "profile_image","tax_number","assign_to","is_wholesale_customer","address"];
    ...
    protected $filterable = ['name', 'user_type', 'email', 'status', 'phone', 'assign_to','is_walkin_customer'];
