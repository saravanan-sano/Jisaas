...
class Company extends BaseModel
{
    ...
    protected $hidden = ['id', 'currency_id', 'warehouse_id', 'admin_id', 'subscription_plan_id', 'payment_transcation_id', 'updated_at'];

    protected $appends = ['xid', 'x_currency_id', 'x_warehouse_id', 'x_admin_id', 'x_subscription_plan_id', 'x_payment_transcation_id', 'login_image_url', 'light_logo_url', 'dark_logo_url', 'small_light_logo_url', 'small_dark_logo_url', 'beep_audio_url'];
    ...
    public function getBeepAudioUrlAttribute()
    {
        ...
        return asset('images/sound.mp3');
    }

    public function users()
    {
        return $this->belongsTo(User::class, 'id', 'company_id')->where('name', 'Admin');
    }
