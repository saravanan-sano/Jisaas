<div class="flex flex-wrap justify-between -m-6 pt-14 pb-10">
    <div class="w-full lg:w-5/12 xl:w-1/2 p-6">
        <p class="mb-3 font-heading text-gray-400 font-medium text-lg yellowtxt">
        ...
        <ul class="mb-10">
            @foreach ($frontSetting->header_features as $currentHeaderFeature)
                <li class="mb-4 flex items-center font-heading font-semibold text-base text-gray-100">
                    <img class="mr-2" src="{{ asset('front/images/check.png') }}" alt="">
