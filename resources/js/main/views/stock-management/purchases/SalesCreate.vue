<template>
            ...
            <a-form layout="vertical">
                ...
                <a-row :gutter="16" class="mt-30">
                    <a-col :xs="24" :sm="24" :md="16" :lg="16">
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-form-item label="Grand Total In Words">
                                    <a-input
                                        :value="
    ...
    <InvoiceModal
        v-if="selectedWarehouse.default_invoice == 'a4_invoice'"
        :visible="printInvoiceModalVisible"
        :order="printInvoiceOrder"
        @closed="printInvoiceModalVisible = false"
    />
    <A5InvoiceModal
        v-if="selectedWarehouse.default_invoice == 'a5_invoice'"
        :visible="printInvoiceModalVisible"
        :order="printInvoiceOrder"
        @closed="printInvoiceModalVisible = false"
    />
...
import A5InvoiceModal from "../invoice-template/a5/A5Invoice.vue";
