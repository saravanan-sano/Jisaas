    ...
    >
        ...
        >
            ...
            <div
                ...
                :key="key"
                class="a4_chunk_wrapper"
            >
                <header class="a4_invoie_header_wraper">
                    <div class="a4_invoie_header" v-if="!order.duplicate">
                        <div
                            class="a4_invoie_header_title"
                ...
                <div class="invoice_product_wrapper">
                    ...
                    >
                        ...
                        <tbody>
                            ...
                            <tr v-if="chunkOrderItem.length == key + 1">
                                <td></td>
                                <td></td>
                                <td
                                    :style="`font-size: ${DFontSize}px`"
                ...
                >
                    ...
                    <div class="a4_invoie_footer_last" v-if="!order.duplicate">
        ...
        <template #footer>
            <div class="footer-invoice-button">
                <a-input-number
                    ...
                    "
                />
                <a-button type="primary" v-print="'#sales_a4_invoice'">
                    <template #icon>
                        <PrinterOutlined />
                    </template>
...
.a4_invoie_gst_total_1 > p:nth-child(1) {
    width: 73%;
    text-align: left;
}
.a4_invoice_gst_footer > div:nth-child(1),
.a4_invoice_gst_footer > div:nth-child(2),
.a4_invoice_gst_footer > div:nth-child(4),
.a4_invoice_gst_footer > div:nth-child(5) {
    font-weight: 900;
}
.a4_invoice_gst_footer > div:nth-child(3),
.a4_invoice_gst_footer > div:nth-child(6) {
    text-align: right;
}
...
.a4_invoie_body_wraper > tbody > td {
    padding: 0 3px;
}
...
.a4_invoice_gst_footer_new {
    display: grid;
    grid-template-columns: 45% 10% 45%;
    width: 100%;
    justify-items: flex-start;
}
.a4_invoice_gst_footer_new > div:nth-child(1),
.a4_invoice_gst_footer_new > div:nth-child(2) {
    font-weight: 900;
}
.a4_invoice_gst_footer_new > div:nth-child(3) {
    text-align: right;
    width: 100%;
}

.a4_invoice_signature {
    border-right: 1px solid #000;
}
.a4_invoie_header_wraper {
    width: 100%;
    border: 1px solid #000;
    border-bottom: none;
}
