<template>
    <a-modal
        ...
        :centered="true"
        :maskClosable="false"
        title="Letterhead Invoice"
        width="22cm"
        @cancel="onClose"
    >
        <div id="letterhead_a4_invoice" class="A4_invoice">
                ...
                <div class="a4_invoice_order_details_wrapper">
                    <div class="a4_invoice_customer_details">
                        ...
                        <div
                            ...
                            v-if="order && order.user && order.user.email"
                        >
                            {{ order.user.email }}
                        </div>
                        <div
                            style="font-size: 12px; text-align: left"
                            v-if="order && order.user && order.user.phone"
                        >
                            {{ order.user.phone }}
                        </div>
                        <div
                            style="font-size: 12px; text-align: left"
                            v-if="order && order.user && order.user.tax_number"
                        >
                            {{ $t("tax.tax_no") }}/UIN :
                        ...
                        <div
                            ...
                            v-if="
                                order && order.order && order.order.delivery_to
                            "
                        >
                    ...
                    <div class="a4_invoice_order_details">
                        ...
                        <div
                            class="a4_invoice_customer"
                            v-if="order && order.order && order.order.gr_rr_no"
                        >
                            <div>GR/RR No</div>
                            <div>:</div>
                            <div>
                        ...
                        <div
                            class="a4_invoice_customer"
                            v-if="order && order.order && order.order.transport"
                        >
                            <div>Transport</div>
                            <div>:</div>
                            <div>
                        ...
                        <div
                            class="a4_invoice_customer"
                            v-if="
                                order && order.order && order.order.vechile_no
                            "
                        >
                            <div>Vehicle No</div>
                            <div>:</div>
                        ...
                        <div
                            class="a4_invoice_customer"
                            v-if="order && order.order && order.order.station"
                        >
                            <div>Station</div>
                            <div>:</div>
                            <div>
                ...
                >
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            >
                                {{
                                    item && item.tax_rate ? item.tax_rate : "-"
                                }}
                            </td>
                            <td style="border: 1px solid #000">
                                {{
        ...
        <template #footer>
            <div class="footer-button">
                <a-button type="primary" v-print="'#letterhead_a4_invoice'">
                    <template #icon>
                        <PrinterOutlined />
                    </template>
...
<style>
#letterhead_a4_invoice {
    text-align: center;
    color: #000;
    font-family: Arial, Helvetica, sans-serif;
}

#letterhead_a4_invoice p {
    margin: 0;
}
</style>
