<template>
    <div class="coupon-container">
        <div class="nav">
            <input type="radio" name="type" value="A" v-model="Type.type" />
            <input type="radio" name="type" value="B" v-model="Type.type" />
            <input type="radio" name="type" value="C" v-model="Type.type" />
            <input type="radio" name="type" value="D" v-model="Type.type" />
            <input type="radio" name="type" value="E" v-model="Type.type" />
        </div>
        <keep-alive>
            <component :is="view" @changeStyle="setStyle"></component>
        </keep-alive>
    </div>
</template>
<script setup>
...
const { Type } = fields();
const emit = defineEmits(["changeStyles"]);
const setStyle = (data) => {
    emit("changeStyles", { type: Type.value.type, data: data });
};
