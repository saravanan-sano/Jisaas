	...
	setup() {
		...
		const setUrlData = () => {
			crudVariables.tableUrl.value = {
				url: `${userType.value}?fields=id,xid,user_type,name,addional_documents,email,profile_image,profile_image_url,phone,details{purchase_order_count,purchase_return_count,sales_order_count,sales_return_count,total_amount,paid_amount,due_amount}`,
				filters: "",
			};
