                ...
                >
                    <template #bodyCell="{ column, record }">
                        ...
                        <template v-if="column.dataIndex === 'staff_user_id'">
                            {{
                                record.staff_member && record.staff_member.name
    ...
    setup(props) {
        ...
        const getData = (propsData) => {
            ...
            datatableVariables.tableUrl.value = {
                url: "sales?fields=id,xid,order_date,invoice_number,total,payment_status,user_id,x_user_id,user{id,xid,name,profile_image,profile_image_url,user_type},staff_user_id,x_staff_user_id,staffMember{id,xid,name,profile_image,profile_image_url,user_type}",
                filters,
                extraFilters: {
