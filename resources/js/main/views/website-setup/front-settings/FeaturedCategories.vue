            ...
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                    <a-form-item
                        ...
                        "
                        :validateStatus="
                            rules.featured_categories_title ? 'error' : null
                        "
                    >
                        <a-input
                            v-model:value="
                                addEditForm.formData.featured_categories_title
                            "
                            :placeholder="
                    ...
                    <a-form-item
                        :label="
                            $t('front_setting.featured_categories_subtitle')
                        "
                    ...
                    <a-form-item
                        ...
                        "
                        :validateStatus="
                            rules.featured_categories ? 'error' : null
                        "
                    >
                        <a-select
                            ...
                            style="width: 100%"
                            :not-found-content="
                                categoryFetching ? undefined : null
                            "
