...
export default defineComponent({
    ...
    setup() {
        const { selectedWarehouse, permsArray } = common();
        const { t } = useI18n();
        const rules = ref({});
        const formData = ref({});
        ...
        const setUrlData = () => {
            const url =
                "front-settings?fields=id,xid,featured_categories,x_featured_categories,featured_products_details,featured_categories_title,featured_categories_subtitle,featured_products,x_featured_products,featured_categories_details,featured_products_title,featured_products_subtitle,facebook_url,twitter_url,instagram_url,linkedin_url,youtube_url,header_line_1,header_line_2,order_thank_msg,app_greeting_msg,app_login_msg,pages_widget,contact_info_widget,links_widget,block_widget,footer_copyright_text,top_banners,top_banners_details,bottom_banners_1,bottom_banners_1_details,bottom_banners_2,bottom_banners_2_details,bottom_banners_3,bottom_banners_3_details,footer_company_description";
            ...
            axiosAdmin.get(url).then((response) => {
                ...
                formData.value = {
                    ...
                    featured_categories_title:
                        responseData.featured_categories_title,
                    ...
                    featured_products_title:
                        responseData.featured_products_title,
                    featured_products_subtitle:
                        responseData.featured_products_subtitle,
                    ...
                    order_thank_msg: responseData.order_thank_msg
                        ? responseData.order_thank_msg
                        : "",
                    app_greeting_msg: responseData.app_greeting_msg
                        ? responseData.app_greeting_msg
                        : "",
                    app_login_msg: responseData.app_login_msg
                        ? responseData.app_login_msg
                        : "",
                    ...
                    block_widget: responseData.block_widget,
                    footer_company_description:
                        responseData.footer_company_description,
