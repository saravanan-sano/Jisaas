            ...
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                    <a-form-item
                        ...
                        "
                        :validateStatus="
                            rules.featured_products_title ? 'error' : null
                        "
                    >
                        <a-input
                            v-model:value="
                                addEditForm.formData.featured_products_title
                            "
                            :placeholder="
                    ...
                    <a-form-item
                        ...
                        "
                        :validateStatus="
                            rules.featured_products ? 'error' : null
                        "
                    >
                        <a-select
