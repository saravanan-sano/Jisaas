            ...
            <a-col :span="24">
                <a-page-header :title="$t(`menu.product_cards`)" class="p-0">
                    <template #extra>
                        <a-button
                            v-if="
                                permsArray.includes('product_cards_create') ||
                    ...
                    >
                        <template #bodyCell="{ column, record }">
                            ...
                            <template v-if="column.dataIndex === 'image'">
                                <a-image :src="record.image_url" style="width: 120px;"/>
                            </template>
...
export default {
    ...
    setup() {
        const { formatAmountCurrency, selectedWarehouse, permsArray } =
            common();
        const { url, initData, columns, filterableColumns, hashableColumns } =
            fields();
