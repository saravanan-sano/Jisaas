            ...
            <a-row :gutter="[16, 16]">
                ...
                <a-col :xs="24" :sm="24" :md="20" :lg="20">
                    <a-row
                        ...
                        v-if="
                            product.details &&
                            product.details.status == 'out_of_stock'
                        "
                    >
                        ...
                        <a-col :xs="24" :sm="24" :md="24" :lg="24">
                            ...
                            >
                                ...
                                >
                                    ...
                                    {{
                                        product.details &&
                                        product.details.sales_tax_type ==
                                            "inclusive"
                                            ? ` (${$t("common.with_tax")})`
                                ...
                                >
                                    {{
                                        product.details && product.hsn_sac_code
                                ...
                                >
                                    {{
                                        product.details &&
                                        product.details.shipping_price
                                            ? `${formatAmountCurrency(
                                                  product.details.shipping_price
                                              )}`
                                            : formatAmountCurrency(0.0)
                                    }}
                                </a-descriptions-item>
                            </a-descriptions>
                        </a-col>
