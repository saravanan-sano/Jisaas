...
import PaymentGateway from '../views/settings/payment-gateway/index.vue';
import CustomFields from '../views/settings/custom-fields/index.vue';
import CommonAdminSettings from "./common/adminSettings";
import SessionLogout from '../views/settings/session-logout/index.vue'
...
export default [
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: 'admin.settings.payment_gateway.index',
                meta: {
                    requireAuth: true,
                    menuParent: "settings",
                    menuKey: route => "payment_gateway",
                    permission: "payment_gateway_view"
                }
            },
            {
                path: 'units',
            ...
            },
            {
				...
				meta: {
					requireAuth: true,
					menuParent: "settings",
					menuKey: "sessionlogout",
					permission: "sessionlogout_view"
				}
			},
            {
                path: 'custom-fields',
