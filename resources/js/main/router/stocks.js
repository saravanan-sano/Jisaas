...
import SalesCreate from '../views/stock-management/purchases/SalesCreate.vue';
import ImportSales from '../views/stock-management/purchases/ImportSales.vue';
import PurchaseCreate from '../views/stock-management/purchases/PurchaseCreate.vue';
import Edit from '../views/stock-management/purchases/Edit.vue';
import SalesEdit from '../views/stock-management/purchases/SalesEdit.vue';
import Purchases from '../views/stock-management/purchases/index.vue';
import SalesReturn from '../views/stock-management/purchases/CreateSalesReturn.vue';
import PurchaseReturn from '../views/stock-management/purchases/CreatePurchaseReturn.vue';
...
export default [
    ...
    {
        path: '/admin/stock/import_sales',
        component: ImportSales,
        name: 'admin.import_sales.index',
        meta: {
            requireAuth: true,
            menuParent: "import_sales",
            menuKey: "import_sales",
            permission: "import_sales_view",
        }
    },
    {
        path: '/admin/stock/',
        ...
        children: [
            ...
            // Quotaiton/Estimate
            {
                ...
                meta: {
                    ...
                    permission: route => 'quotation_edit',
            ...
            },
            {
                ...
                meta: {
                    ...
                    menuParent: "sales",
                    menuKey: route => "quotations",
                    permission: route => 'quotation_create',
                    orderType: "quotations"
                }
            },
            {
                ...
                meta: {
                    ...
                    menuParent: "sales",
                    menuKey: route => "quotations",
                    permission: route => 'quotation_view',
                    orderType: "quotations"
                }
            },
