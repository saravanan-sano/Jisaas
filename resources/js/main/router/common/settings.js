...
const routePrefix = appType == 'single' ? 'admin' : 'superadmin';
...
export default [
    {
        ...
        meta: {
            ...
            permission: appType == 'single' ? "translations_view" : "superadmin"
        }
    },
    {
        path: 'modules',
        ...
        meta: {
            ...
            permission: appType == 'single' ? "modules_view" : "superadmin"
        }
    },
    {
        path: 'storage',
        ...
        meta: {
            ...
            permission: appType == 'single' ? "storage_edit" : "superadmin"
        }
    },
    {
        path: 'email',
        ...
        meta: {
            ...
            permission: appType == 'single' ? "email_edit" : "superadmin"
        }
    },
    {
        ...
        meta: {
            ...
            permission: appType == 'single' ? "database_backup" : "superadmin"
        }
    },
    {
        path: 'update-app',
        ...
        meta: {
            ...
            permission: appType == 'single' ? "update_app" : "superadmin"
        }
    }
];
