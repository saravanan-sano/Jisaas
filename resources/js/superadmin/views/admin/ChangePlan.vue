                ...
                <a-row :gutter="16" class="mb-20">
                    <a-col :span="24">
                        <a-alert
                            ...
                            :description="
                                $t(
                                    'payment_settings.payment_success_give_some_time'
                                )
                            "
                            type="success"
                            show-icon
                        ...
                        <a-card style="padding-bottom: 20px" hoverable>
                            <a-row :gutter="16">
                                ...
                                >
                                    ...
                                    >
                                        <li  v-for="subscritpionPlanFeature in allSubscriptionPlan.features"
                                        :key="subscritpionPlanFeature">{{ subscritpionPlanFeature }}</li>
                                    </ul>
                                </a-col>
                                <a-col
                                    :xs="24"
                                ...
                                >
                                    <a-typography-title :level="3">
                                        {{
                                            packageType == "monthly"
                                                ? `${allSubscriptionPlan.currency_symbol}${allSubscriptionPlan.monthly_price}`
                                                : `${allSubscriptionPlan.currency_symbol}${allSubscriptionPlan.annual_price}`
                                        }}
                                    </a-typography-title>
                                    <span>
                                        {{
                                            packageType == "monthly"
                                                ? $t(
                                                      "subscription_plans.per_month"
                                                  )
                                                : $t(
                                                      "subscription_plans.per_year"
                                                  )
                                        }}
                                    </span>
                                </a-col>
