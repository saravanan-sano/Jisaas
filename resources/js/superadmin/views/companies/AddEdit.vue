    ...
    >
        <a-form layout="vertical">
            <a-tabs v-model:activeKey="activeTabKey">
                ...
                <a-tab-pane key="logo_details" :tab="$t('menu.company')">
                    <a-row :gutter="16">
                    ...
                    <a-row :gutter="16">
                        <a-col :xs="24" :sm="24" :md="6" :lg="6">
                            <a-form-item
                                :label="$t('company.app_layout')"
                                name="app_layout"
                                :help="
                                    rules.app_layout
                                        ? rules.app_layout.message
                                        : null
                                "
                                :validateStatus="
                                    rules.app_layout ? 'error' : null
                                "
                            >
                                <a-select
                                    v-model:value="formData.app_layout"
                                    style="width: 200px"
                                >
                                    <a-select-option value="sidebar"
                                        >Side Bar</a-select-option
                                    >
                                    <a-select-option value="topbar"
                                        >Top Bar</a-select-option
                                    >
                                </a-select>
                            </a-form-item>
                        </a-col>
            ...
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                    <a-form-item
                        ...
                        name="user_email"
                        :help="
                            rules.user_email ? rules.user_email.message : null
                        "
